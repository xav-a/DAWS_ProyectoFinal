...
class AllRecentPosts extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: []
  ...
  componentDidMount() {
    $.ajax({
      url: `http://127.0.0.1:3000/show/posts/`,
      dataType: "json",
      cache: false,
...
class NewPost extends Component {
  ...
  handleSubmit(event) {
    ...
    object["imageURL"] =
      object["imageURL"].trim() === "" ? null : object["imageURL"].trim();
...
export { AllRecentPosts, AllPosts, Post, NewPost, EditPost };
